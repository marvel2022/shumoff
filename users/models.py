...
class NewUser(AbstractBaseUser, PermissionsMixin):
    ...
    first_name = models.CharField(_("Имя пользователя"), max_length=150)    
    phone_number = models.CharField(_("Телефонный номер"), max_length=13, unique=True) # validators should be a list
